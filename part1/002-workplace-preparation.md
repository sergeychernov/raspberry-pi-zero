...
Эта строка называется инструкцией, для удобства принято разделять инструкции точкой с запятой в конце.

Каждую инструкцию принято начинать с новой строчки, хотя это необязательно, я настоятельно рекомендую следовать этой рекомендации, этим ты поможешь себе в будущем, так как это сделает твой код понятней для тебя самого.
