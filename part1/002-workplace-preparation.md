...
Теперь, если Raspberry PI у тебя в кармане, ты можешь приступать к [следующей главе](003-raspberry-pi-zero-preparation).

А если нет, то самое время освоить бесплатный курс ["Основы командной строки"](https://ru.hexlet.io/courses/cli-basics)
