...
Данная инструкция создаст переменную с именем message, которой ты потом можешь присвоить значение. В качестве имени переменной можно использовать любой набор английских символов и цифр. Но лучше использовать какие-то осмысленные слова на английском, это сделает твой код более понятным.
...
Чтобы импорты работали, необходимо в ```package.json``` добавить
...
На [следующем уроке](005-led-onoff.md) ты узнаешь как управлять светодиодами с помощью команд.
